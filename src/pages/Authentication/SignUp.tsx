...
const SignUp: React.FC = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (type === "student") {
        const response = await axios.post('https://ereside-backend-1.onrender.com/api/v1/usignup', {
        ...
        const response = await axios.post('https://ereside-backend-1.onrender.com/api/v1/asignup', {
