...
const SignIn: React.FC = () => {
  ...
  const addinpdata = async (e) => {
    ...
    try {
      ...
      if (type === "student") {
        const response = await axios.post('https://ereside-backend-1.onrender.com/api/v1/usignin', {
          email,
          password,
        })
        ...
        const response = await axios.post('https://ereside-backend-1.onrender.com/api/v1/wsignin', {
          email,
          password,
        })
        if (response.status === 200) {
        ...
        const response = await axios.post('https://ereside-backend-1.onrender.com/api/v1/asignin', {
          email,
          password,
        })
        if (response.status === 200) {
