...
const Settings = () => {
  ...
  const setdata = (e) => {
    ...
    const updateProfilePic = async(e)=>{
        ...
        const res2 = await fetch(`https://ereside-backend-1.onrender.com/api/v1/editImage`,{
            method: "PATCH",
            headers: {
  ...
  const updateProfile = async (e) => {
    ...
    const res2 = await fetch(`https://ereside-backend-1.onrender.com/api/v1/editStudentProfile`, {
        method: "PATCH",
        headers: {
            "Content-Type": "application/json",
            "Authorization": `Bearer ${token}`
